        ...
        try:
            if ".dcm" in s.lower():  # check whether the file is DICOM
                ...
                if hasattr(ds, "SliceLocation"):
                    ...
                    'Slice was either aligned already or is a scout view'
...
app.config["JPG"] = r'C:\Users\MSStore\WebApp\static\JPG_converts'
...
app.config["adc_ALIGN"] = r'C:\Users\MSStore\WebApp\static\Aligned_DICOM\adc'
app.config["highb_ALIGN"] = r'C:\Users\MSStore\WebApp\static\Aligned_DICOM\highb'
app.config["t2_ALIGN"] = r'C:\Users\MSStore\WebApp\static\Aligned_DICOM\t2'
...
def index ():
    ...
    clearFiles(app.config["ALIGNED"])
    clearFiles(app.config["JPG"])
...
def api_receiveMarkup():
    if request.method == 'POST':
        print("These are the marked coordinates: ")
        print(request.form)
